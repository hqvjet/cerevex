...
# Load .env specifically from the user-service root (two levels up from this file)
...
class Settings:
    ...
    # Default access token TTL is 1 day (1440 minutes)
    access_token_ttl_min: int = int(_env("ACCESS_TOKEN_TTL_MIN", "1440"))
